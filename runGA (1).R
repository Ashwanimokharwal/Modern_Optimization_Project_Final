...
runGA <- function(noRuns = 30, problem = "feature", popSize = 15, pmutation = 0.1, pcrossover = 0.2){
...
#results1 <- runGA(noRuns = 30, problem = "tsp", popSize = 30)
#results2 <- runGA(noRuns = 30, problem = "tsp", popSize = 60)
#results3 <- runGA(noRuns = 30, problem = "tsp", popSize = 90)

#changes in mutation sizes
results1 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pcrossover = 0.2, pmutation = 0.2)
results2 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pcrossover = 0.4, pmutation = 0.4)
results3 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pcrossover = 0.6, pmutation = 0.6)